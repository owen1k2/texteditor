...
public class TextEditor {
    ...
    /**
     * Private helper function that updates the screen with the letter just typed.
     * @param buf the GapBuffer that is being used to store the characters typed.
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(isRunning) {
            ...
            if(null != stroke.getKeyType()) switch (stroke.getKeyType()) {
                case Character:
                    buffer.insert(stroke.getCharacter());
                    screen.setCharacter(buffer.getCursorPosition(), 0 , new TextCharacter(stroke.getCharacter()));
